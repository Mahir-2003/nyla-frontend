...
async function main() {
  try {
    const assistant = await openai.beta.assistants.create({
      name: "Parenting Teacher",
      instructions:
        "You are a helpful parenting assistant. Answer questions that parents may have about parenting without being too verbose.",
      tools: [],
    ...
    console.log(
      "\nHello there, I'm your personal parenting assistant. Ask me anything :)\n"
    );
